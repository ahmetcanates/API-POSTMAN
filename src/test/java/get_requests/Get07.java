...
public class Get07 extends JsonPlaceHolderBaseUrl {
     /*
      ...
      Then
          ...
          2)Print all ids greater than 190 on the console ==> id si 190 dan buyuk olanlarin idlerini konsola yazdirin
    ...
    public void get07() {
        ...
        //do assertion
        Assert.assertEquals(200,response.statusCode());//Status code is 200

        //Print all ids greater than 190 on the console
        JsonPath jsonPath = response.jsonPath();
        List<Integer> list = jsonPath.getList("findAll{it.id>190}.id");//Groovy Language Java temelli bir programlama dilidir(restassure'den gelir)
        ...
        //Assert that "delectus aut autem" is one of the titles whose id is less than 5 ==> id si 5 den kucuk olan datalarin birinin
        //basliginin "delectus aut autem" icerdigini dogrulayin
        Assert.assertTrue("title uyusmadi",titleList.contains("delectus aut autem"));
